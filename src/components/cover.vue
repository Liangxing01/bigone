	...
	<section>
		<div class="apps">
			<el-breadcrumb>
			    ...
			    <el-breadcrumb-item>智能井盖</el-breadcrumb-item>
			</el-breadcrumb>
			    	...
			    	<el-row :gutter="20">
					  	<el-col :span="12">
						  	<div class="grid-content bg-purple apps-parking">
						  		<h3>应用概览</h3>
					  			<p class="parking-manage">智能井盖<i class="el-icon-edit"></i></p>
						  		<p>
						  			<span>应用ID</span>
						...
						<el-row :gutter="20">
					  	<el-col :span="16">
						  	<div class="grid-content bg-purple apps-data">
						  		<h3>实时数据</h3>
						  ...
						  <el-col :span="8">
						  	<div class="grid-content bg-purple apps-data">
						  		<h3>数据流量</h3>
						  		<div id="flow" style="width: 100%; height: 460px;padding: 0 20px 0 30px;"></div>
						  	</div>
						  </el-col>
						</el-row>
			    </el-tab-pane>
...
<style scoped>
	...
	.el-tabs{ position: relative; top: 10px }
	.el-tabs__header{ border: none; }
	...
	.apps-num span{ display: block; text-align: center;font-family: "宋体";}
	.apps-num span:first-child{ line-height: 70px; color: #fff;	font-size: 24px;  }
	.apps-num .apps-num-des1{ background: #20b6cf;}
	.apps-num .apps-num-des2{ background: #ff6d61;}
	.apps-num .apps-num-des3{ background: #f8d348;}
	...
	.apps-list{font-size: 18px; text-align: left; color: #747474; padding-left: 10px; line-height: 36px;}
